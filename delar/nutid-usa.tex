\subsection{Amerikanska patentsystemet på 1900-talet} 
...
%*här läggs fokus på information till allmänheten som grundläggande idé, axiomatiskt. kanske ka tona ner det och istället säga att et här systemet gynnar allmänheten eller inte.
...
%*jättebra term men källan suger, sticker i ögat att ha populär media som källa.
...
%*förtydliga att om kunskapen redan är känd -ej patenterbar *nu underförstått att alla har first to file -tydligare?
