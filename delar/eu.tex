...
Man gör alltså bara en ansökan, men om patentet beviljas måste översättningar av patentet lämnas in, och avgifter erläggas, i de länder där patentet ska gälla \cite{howtoeupat}.
...
En uppskattning är att det kostar ca tjugo gånger mer att skydda en uppfinning i EU än i USA \cite{ftimes_eupat}.
Oavsett vilken väg som väljs multipliceras avgifter och översättningskostnader för nära trettio länder och gör det minst sagt kostsamt att patentera en uppfinning i Europa.
...
Fördelarna med så kallade \emph{unitary patent} är ett förenklat förfarande vid ansökan, minskade kostnader, och ett enhetlig juridisk effekt \cite{euunitary}.
Även efter dessa förändringar så blir det flera gånger dyrare att söka patent i EU än i exempelvis USA och Kina \cite{unitarycost}.

Den europeiska patentkonventionen, EPC, överensstämmer med GATT i de flesta avseenden.
En utmärkande skillnad är att EPC artikel 52 fastslår att datorprogram inte är uppfinningar, och därför inte är patenterbara\cite{epc}.
Samma artikel utesluter även patent på växter och djur.
Liksom de flesta andra länders patentsystem kan EPC sägas utöva \emph{first to file}-principen, då nyheten av ett patent bedöms även i ljuset av tidigare inlämnade, men ännu ej beviljade patentansökningar \cite{epc}.
