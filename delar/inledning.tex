...
får svårt att hinna med \cite{uspto_number}. Se figur \ref{fig:holg} som visar antalet patentansökningar i olika länder, märk skillnade in i gradering mellan länderna\footnote{grafen är tagen ifrån \cite{holg}}.
