...
\subsection{Kolonier med inspiration från England} % (fold) \label{sub:inspiration_från_england}
...
\subsection{Oberoende och Enade USAs patent system} % (fold) \label{sub:enade_usas_patent_system}

% subsection enade_usas_patent_system (end)
